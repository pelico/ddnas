...
.music-list{position:fixed;left:0;right:0;bottom:166px;z-index:40;background:var(--card);border-top:1px solid var(--bd);max-height:240px;min-height:80px;overflow:auto;padding:6px 0;display:none;box-shadow:0 -2px 12px rgba(0,0,0,.12)}
